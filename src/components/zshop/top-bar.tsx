      ...
      <div className="mx-auto flex h-9 max-w-7xl items-center justify-between gap-2 px-3 text-xs sm:px-6">
        <div className="flex min-w-0 items-center gap-3 overflow-hidden">
          <span className="hidden items-center gap-1.5 sm:flex">
            <Truck className="h-3.5 w-3.5 shrink-0 text-amber-400" />
          ...
          <span className="hidden items-center gap-1.5 md:flex">
            <BadgePercent className="h-3.5 w-3.5 shrink-0 text-amber-400" />
            Use code <strong className="font-semibold text-amber-300">WELCOME15</strong> for 15% off
          </span>
        </div>
